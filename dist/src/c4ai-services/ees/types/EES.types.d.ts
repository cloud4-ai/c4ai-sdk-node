...
import { C4AI_AAC_Execute_Command } from "../../aac/commands/AAC-Execute.command";
export type C4AI_SDK_TYPES__EES_JSON = {} & C4AI_SDK_TYPES__IAPIServiceEntity;
...
export declare enum C4AI_SDK_TYPES__EES_ExecutionPriority {
    /**
